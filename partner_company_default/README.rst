...
.. |badge3| image:: https://img.shields.io/badge/github-qrtl%2Ftng--oca-lightgray.png?logo=github
    :target: https://github.com/qrtl/tng-oca/tree/16.0/partner_company_default
    :alt: qrtl/tng-oca
...
`feedback <https://github.com/qrtl/tng-oca/issues/new?body=module:%20partner_company_default%0Aversion:%2016.0%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.
...
This module is part of the `qrtl/tng-oca <https://github.com/qrtl/tng-oca/tree/16.0/partner_company_default>`_ project on GitHub.
